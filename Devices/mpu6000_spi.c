...
void mpu6000_cfg(void)
{
	...
	HAL_SPI_TransmitReceive(&hspi3, who_am_i_tx, dummy_rcv, 2, 1);
	__HAL_SPI_DISABLE(&hspi3);
	HAL_Delay(1);
	__HAL_SPI_ENABLE(&hspi3);
	HAL_SPI_TransmitReceive(&hspi3, pwr_manage, dummy_rcv, 2, 1);
	__HAL_SPI_DISABLE(&hspi3);
	HAL_Delay(1);
	__HAL_SPI_ENABLE(&hspi3);
	HAL_SPI_TransmitReceive(&hspi3, smplrt_div, dummy_rcv, 2, 1);
	__HAL_SPI_DISABLE(&hspi3);
	HAL_Delay(1);
	__HAL_SPI_ENABLE(&hspi3);
	HAL_SPI_TransmitReceive(&hspi3, config, dummy_rcv, 2, 1);
	__HAL_SPI_DISABLE(&hspi3);
	HAL_Delay(1);
	__HAL_SPI_ENABLE(&hspi3);
	HAL_SPI_TransmitReceive(&hspi3, gyro_cfg, dummy_rcv, 2, 1);
	__HAL_SPI_DISABLE(&hspi3);
	HAL_Delay(1);
	__HAL_SPI_ENABLE(&hspi3);
	HAL_SPI_TransmitReceive(&hspi3, accel_cfg, dummy_rcv, 2, 1);
	__HAL_SPI_DISABLE(&hspi3);
	HAL_Delay(1);
	__HAL_SPI_ENABLE(&hspi3);
	HAL_SPI_TransmitReceive(&hspi3, user_ctrl, dummy_rcv, 2, 1);
	__HAL_SPI_DISABLE(&hspi3);
	HAL_Delay(1);
	__HAL_SPI_ENABLE(&hspi3);
	HAL_SPI_TransmitReceive(&hspi3, int_pin_cfg, dummy_rcv, 2, 1);
	__HAL_SPI_DISABLE(&hspi3);
	HAL_Delay(1);
	__HAL_SPI_ENABLE(&hspi3);
	HAL_SPI_TransmitReceive(&hspi3, int_enable, dummy_rcv, 2, 1);
	__HAL_SPI_DISABLE(&hspi3);
}
void mpu6000_read_all(void)
{
	...
	__HAL_SPI_ENABLE(&hspi3);
	HAL_SPI_TransmitReceive(&hspi3, acc_gyr_tx, acc_gyr_spi_rx, 15, 5);
	__HAL_SPI_DISABLE(&hspi3);
	for (i=0; i<3; i++){
...
{
	__HAL_SPI_ENABLE(&hspi3);
	HAL_SPI_TransmitReceive_DMA(&hspi3, acc_gyr_spi_tx, acc_gyr_spi_rx, 15);
//	__HAL_SPI_ENABLE_IT(&hspi3, (SPI_IT_TXE | SPI_IT_RXNE | SPI_IT_ERR));
